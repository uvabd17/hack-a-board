                ...
                <div className="border-2 border-border bg-card/60 backdrop-blur-sm rounded-xl">
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        >
                            <button
                                type="submit"
                                className="w-full group relative overflow-hidden rounded-xl border-2 border-border border-b-[4px] bg-card hover:bg-primary/5 hover:border-primary/40 active:border-b-2 active:mt-[2px] transition-all duration-100 px-6 py-5 flex items-center justify-center gap-3 cursor-pointer select-none"
                            >
                                {/* Google Icon */}
                                ...
                                <span className="text-sm font-black tracking-wide text-foreground/80 group-hover:text-foreground transition-colors">
                        ...
                        {process.env.NODE_ENV === "development" && (
                            ...
                            >
                                <button
                                    type="submit"
                                    className="w-full rounded-xl border-2 border-amber-500/30 border-b-[4px] border-b-amber-500/20 bg-amber-500/5 hover:bg-amber-500/10 active:border-b-2 active:mt-[2px] transition-all duration-100 px-6 py-4 flex items-center justify-center gap-2 cursor-pointer select-none"
                                >
